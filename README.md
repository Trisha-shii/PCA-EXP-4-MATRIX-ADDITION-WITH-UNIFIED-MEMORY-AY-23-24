...
<h3>ENTER YOUR REGISTER N : 212224230293O</h3>
<h3>EX. NO: 4</h3>
...
//   Type your code here to launch your kernel
    ...
    sumMatrixGPU<<<grid, block>>>(A, B, gpuRef, nx, ny); //one dimension gpuref-pointer which is created from the cpu for fetching input
...
```python
!nvprof ./unifmem1 //nvdia profiler
```
...
```
```python
!nvprof ./unifmem2 //nvdia profiler
```
## OUTPUT:
<img width="1586" height="370" alt="image" src="https://github.com/user-attachments/assets/902942c2-4642-49cd-8fe6-5a71a022704e" />
<img width="1658" height="183" alt="image" src="https://github.com/user-attachments/assets/4deee52a-a180-4816-8bf5-f17edee53884" />
<img width="1333" height="781" alt="image" src="https://github.com/user-attachments/assets/e6d676bd-2a8c-4570-b66b-705a3f85bad2" />
<img width="1711" height="141" alt="image" src="https://github.com/user-attachments/assets/1592ccf4-7593-4468-b705-36eddba694a0" />
<img width="1346" height="734" alt="image" src="https://github.com/user-attachments/assets/01ee0f28-6b40-408d-b133-da2dd694e764" />


## RESULT:
Thus the program has been executed by using unified memory. It is observed that removing memset function has given more 0.000054 time.
